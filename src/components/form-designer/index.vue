  ...
  <el-container class="main-container full-height">
    ...
    <el-header class="main-header">
      <div class="float-left main-title">
        ...
        <span class="bold">{{platName}}</span><span class="version-span">V{{logConfig.info[0].version}}</span></div>
      <div class="float-right external-link">
      <div class="log" @click="showLogBtn">更新日志</div>
      <Log v-if="showLog" :title="platName" :datas="logConfig" @close="logClose" />
...
<script>
  ...
  import logConfig from "@/utils/version";
