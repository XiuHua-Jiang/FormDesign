...
import {imgSchema} from "@/extension/samples/extension-schema"
import ImgWidget from '@/extension/samples/img/img-widget'
...
export const loadExtension = function () {
  ...
  addCustomWidgetSchema(imgSchema)  //加载组件Json Schema
  /* -------------------------------------------------- */
  Vue.component(AlertWidget.name, AlertWidget)  //注册组件
  Vue.component(ImgWidget.name, ImgWidget)  //注册组件
  /* -------------------------------------------------- */
  ...
  PERegister.registerCPEditor('alert-marginTop', 'alert-marginTop-editor',
    PEFactory.createInputTextEditor('marginTop', 'extension.setting.marginTop'))

  PERegister.registerCPEditor('alert-marginBottom', 'alert-marginBottom-editor',
    PEFactory.createInputTextEditor('marginBottom', 'extension.setting.marginBottom'))
